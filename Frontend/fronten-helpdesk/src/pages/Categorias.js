...
const getRouteByRole = (section) => {
  ...
  switch(section) {
    case 'inicio':
      return userRole === 'administrador' ? '/Superadmin' : 
             userRole === 'tecnico' ? '/HomeAdmiPage' : '/home';
    
    case 'crear-caso':
      return userRole === 'administrador' ? '/CrearCasoAdmin' : 
             userRole === 'tecnico' ? '/CrearCasoAdmin' : '/CrearCasoUse';
    
    case 'tickets':
      return userRole === 'administrador' ? '/TicketsAdmin' : 
             userRole === 'tecnico' ? '/TicketsTecnico' : '/Tickets';
    default:
      return '/home';
  }
};
